...
1506 hermetic tests passing. Every validation check is grounded in explicit
...
Phase 6.D is now in progress: 6.D.A (ts-refclk + mediaclk presence) and
6.D.B (ST 2110-30 L16/L24 MAXUDP-forbidden) have shipped.
