...
describe("IPMX validation", function()
  ...
  -- ── Leaf values: bandwidth, infoframe, ts-refclk ────────────────────────────────
  ...
  -- ── Per-encoding fmtp blocks (IPMX baseband, JPEG-XS, audio) ────────────────────
  ...
  -- ── Cross-media / cross-session: a=group:DUP and a=privacy inheritance ──────────
  ...
  -- ── Feature: HKEP — HDCP Key Exchange Protocol (TR-10-5) ────────────────────────
  ...
  -- ── Feature: PEP — a=privacy (TR-10-13) ─────────────────────────────────────────
